<template>
  ...
  >
      ...
      >
        ...
        <el-form-item label="标题选择器">
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.main.titleSelector"
              type="text"
            />
          </span>
        </el-form-item>
    ...
    >
      <el-form
        :model="formData.domItem"
        label-width="100px"
      >
        <!-- f启用按钮 -->
        <el-form-item label="启用">
          <el-checkbox
            v-model="formData.domItem.enable"
            type="checkbox"
          />
        </el-form-item>
        <!-- f选择器 -->
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.domItem.selector[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.linkUrl.selector[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.linkUrl.attribute[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
    ...
    >
      <el-form
        :model="formData.picUrl"
        label-width="100px"
      >
        <!-- f启用按钮 -->
        <el-form-item label="启用">
          <el-checkbox
            v-model="formData.picUrl.enable"
            type="checkbox"
          />
        </el-form-item>
        <!-- f选择器 -->
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.picUrl.selector[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.picUrl.attribute[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.name.selector[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.name.attribute[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.meta.selector[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
        ...
        >
          ...
          <span style="flex-grow: 1">
            <el-input
              v-model="formData.meta.attribute[index]"
              type="text"
            />
          </span>
          <!-- s侧边按钮 - 增加匹配规则-->
    ...
    >
      <el-form
        :model="formData.filter"
        label-width="100px"
      >
        <el-form-item label="格式(初始)">
          <SelectorFormat
            style="padding: 0 24px"
            :options="toolBarStore.filter.formats.options"
            :value="formData.filter.formats"
            @update="(val) => (formData!.filter.formats = val)"
            font-size="auto"
            :max-collapse-tags="5"
          />
        </el-form-item>
        <el-form-item label="宽度(初始)">
          <InputNumberRange
            :value="formData.filter.width"
            @update="(val)=>{formData!.filter.width = val}"
          />
        </el-form-item>
        <el-form-item label="高度(初始)">
          <InputNumberRange
            :value="formData.filter.height"
            @update="(val)=>{formData!.filter.height = val}"
          />
        </el-form-item>
      </el-form>
    </el-tab-pane>
